 ...
 * Bootloader-Z Notice:
 * 
 * This file is intentionally brought into the project to replace STM32Cube's STM32F1xx 
 * implementation, which does not allow customization of EPIN / EPOUT packet sizes.
 */
